...
private:
  ...
  class EgressCallback
      : public proxygen::coro::detail::WtStreamManager::EgressCallback {
  public:
  ...
  class IngressCallback
      : public proxygen::coro::detail::WtStreamManager::IngressCallback {
  public:
  ...
  std::unique_ptr<proxygen::coro::detail::WtStreamManager> streamManager_;
